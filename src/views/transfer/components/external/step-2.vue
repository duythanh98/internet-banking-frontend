<template>
  <div style="text-align: center">
    <p>Vui lòng nhập OTP ứng với mã giao dịch: <strong>{{ transfer.transfer_code }}</strong></p>
    ...
    <div style="text-align: center; margin-top: 20px">
      <el-button :disabled="formInvalid" type="primary" @click="nextStep">Chuyển khoản</el-button>
